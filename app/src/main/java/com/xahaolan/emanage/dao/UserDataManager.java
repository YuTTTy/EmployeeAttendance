package com.xahaolan.emanage.dao;
...
public class UserDataManager {
    private static final String TAG = "UserDataManger";
    ...
    public static final String DB_CREATE = "CREATE TABLE " + TABLE_NAME + " (" +
            ID + " integer primary key," + USER_NAME + " varchar," + USER_PWD +
             " varchar," +USER_DEPARTMENT_NAME+ " varchar,"+USER_GENDER+" varchar"+");";
    ...
    public int findUserByNameAndPwd(String userName, String pwd){
        ...
        int result=0;
        Cursor mCursor=mSQLiteDatabase.query(TABLE_NAME, null, USER_NAME+"='"+userName+"' and " +
                        ""+USER_PWD+"='"+pwd+"'",
                null, null, null, null);
        if(mCursor!=null){
            result=mCursor.getCount();
