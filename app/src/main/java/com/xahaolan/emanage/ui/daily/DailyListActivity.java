...
public class DailyListActivity extends BaseActivity {
    ...
    public void setTitleAttribute() {
        setTitle(0, R.color.titleBg, R.drawable.ic_launcher_round, "", R.color.baseTextMain, "日报", R.color.baseTextMain, "", R.color.baseTextMain, R.drawable.ic_launcher_round);
    }
